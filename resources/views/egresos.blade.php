...
<div class="block-header">
    <div class="row card" style="padding: 2%;">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <select class="form-control" name="proyectos" id="cbProyectos" onchange=""></select>
            </div>
            <div class="col-md-6 mb-2">
                <div class="col-md" align="right">
                    <button type="button" id="btn-nuevo-egreso" class="btn waves-effect waves-light btn-outline-danger btn-agregar float-right btn-rounded" data-toggle="modal" data-target="#modalEgresos">Nuevo egreso</button>
                </div>
                <br>
            </div>
    </div>
...
<div class="modal fade" id="modalEgresos" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header" style="color: white; background: #255070; padding-bottom: 15px;">
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                <h4 class="modal-title text-white" id="modal-title">Registrar nuevo egreso</h4>
            </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="tipoGasto" id="cbTipoGasto" onchange=""></select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
                                ...
                                <div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="unidad" id="cbUnidades" onchange=""></select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                          <input class="form-control" type="number" step="1" value="0" required="required" id="cantidad" name="cantidad" style="border:1px solid #c9c8c7; padding: 5px; " />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
