...
<div class="block-header">
	...
	<div class="col-xs-12 sm-2">
		...
		<div class="col-md" align="right">
			...
			<button type="button" id="btn-addMaterial"
				class="btn-agregar btn waves-effect waves-light btn-outline-danger float-right btn-rounded"
				data-toggle="modal" data-target="#modalProyecto">Agregar Material</button>
					...
					<table class="table table-bordered table-striped table-hover" id="tablaProyectos">
						...
						<thead>
							...
							<tr>
								...
								<th>Proveedor</th>
								<th>Total</th>
								<th style="max-width: 170px; min-width: 150px">Acciones</th>
								<th>id</th>
							</tr>
	...
	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header" style="color: white; background: #255070; padding-bottom: 15px;">
				...
				<h4 class="modal-title text-white" id="modal-title">Agregar Material</h4>
					...
					<div class="col-sm-8">
						<form id="frm-registrar" method="POST" enctype="multipart/form-data" class="form-horizontal">
							<div class="card-content">
										...
										<div class="row">
											...
											<div class="col-sm-9">
												...
												<input class="form-control" type="text" required="required"
													id="idMaterial" name="idMaterial"
													style="border:1px solid #c9c8c7; padding: 5px; " />
								...
								<fieldset id="selectProveedorField">
								...
								<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
									...
									<div class="row">
										...
										<div class="col-sm-9">
											...
											<input class="form-control" type="text" required="required" id="descripcion"
												name="descripcion" style="border:1px solid #c9c8c7; padding: 5px; " />
								...
								<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
									<div class="row">
										...
										<div class="col-sm-9">
											<select class="form-control" name="unidad" id="marcas"
												style="border:1px solid #c9c8c7; padding: 5px; ">
								...
								<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
									<div class="row">
										...
										<div class="col-sm-9">
											<input class="form-control" type="number" required="required" id="cantidad"
												name="cantidad" style="border:1px solid #c9c8c7; padding: 5px; " />
										</div>
									</div>
								</div>
								<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
								...
								<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
									<div class="row">
										...
										<div class="col-sm-9">
											<input value="0" disabled class="form-control" type="number"
												required="required" id="iva" name="iva"
												style="border:1px solid #c9c8c7; padding: 5px; " />
										</div>
									</div>
								</div>
								<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
									<div class="row">
										...
										<div class="col-sm-9">
											<input disabled class="form-control" type="number" required="required"
												id="total" name="total"
												style="border:1px solid #c9c8c7; padding: 5px; " />
										</div>
									</div>
								...
								<fieldset id="datosProveedor" hidden>
									<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
										<div class="row">
											<label class="col-sm-3 control-label">
												Proveedor
								...
								<div class="modal-footer">
									...
									<button type="button" name="modal-btn-save" class="btn btn-success"
										id="modal-btn">Registrar</button>
