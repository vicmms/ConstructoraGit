...
<div class="block-header">
    ...
    <div class="col-xs-12 sm-2">
        ...
        <div class="col-md" align="right">
            ...
            <button type="button" id="btn-addManoObra" class="btn-agregar btn waves-effect waves-light btn-outline-danger float-right btn-rounded" data-toggle="modal" data-target="#modalProyecto">Agregar Unidad de Medida</button>
	...
	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header" style="color: white; background: #255070; padding-bottom: 15px;">
							...
							<h4 class="modal-title text-white" id="modal-title">Agregar Unidades de Medida</h4>
									...
									<div class="form-group edit-hidden">
													...
													<div class="row">
																	...
																	<div class="col-sm-9">
																					...
																					<input class="form-control" type="text" required="required" id="idUnidad" name="idUnidad" style="border:1px solid #c9c8c7; padding: 5px; "  />
								...
								<div class="form-group" style="padding-top: 20px; padding-buttom: 20px;">
												...
												<div class="row">
																...
																<div class="col-sm-9">
																				...
																				<input class="form-control" type="text" required="required" id="unidad" name="unidad" style="border:1px solid #c9c8c7; padding: 5px; " />
...
<script src="{{asset('js/unidadesMedida.js')}}"></script>
