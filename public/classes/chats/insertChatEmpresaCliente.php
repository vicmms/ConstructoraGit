...
<?php
  ...
  if($conn)
  {
    $tsql_callSP = "{call appLiderCatalogoChatEmpresaTEmpresaCSPInsert(?,?,?,?,?)}";
          $params = array( 
      ...
      { 
        ...
        sendMessage($arr, $_POST['datos'][0]['chat'], $_SESSION['claveEmpresa']);
  ...
  function sendMessage($array, $chat, $prov){ 
    
    $dataArray=array();
    $dataArray['TipoNotificacion'] = '1';
    $dataArray['cveProveedor'] = $prov;
