...
<?php
  ...
  if($conn)
  {
      $tsql_callSP = "{call appLiderCatalogoChatRutaProgramacionInsert(?,?,?,?,?,?)}";

    
      $params = array( 
                  array($_SESSION['claveEmpresa'], SQLSRV_PARAM_IN), 
                  array($_POST['datos'][0]['claveEmpresaC'], SQLSRV_PARAM_IN),
      ...
      { 
        ...
        sendMessage($arr, $_POST['datos'][0]['chat'], $_SESSION['claveEmpresa'], $_POST['datos'][0]['claveEmpresaC'], $_POST['datos'][0]['claveProgramacion']);
  ...
  function sendMessage($array, $chat, $claveEmpresaT, $claveEmpresaC, $claveProgramacion){ 
    $dataArray=array();
    $dataArray['TipoNotificacion'] = '4';
    $dataArray['claveEmpresaT'] = $claveEmpresaT;
    $dataArray['claveEmpresaC'] = $claveEmpresaC;
    $dataArray['clavePrograma'] = $claveProgramacion;

    $titulo= 'Nuevo mensaje de chat de ruta';
